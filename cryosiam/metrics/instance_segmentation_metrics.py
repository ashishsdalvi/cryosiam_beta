# Code adapted from: https://github.com/kreshuklab/go-nuclear/blob/main/evaluation/evaluate.py
import numpy as np
...
class SegmentationMetrics:
    ...
    def __init__(self, gt, seg):
        self.unique_labels_gt, gt = relabel(gt)
        self.unique_labels_seg, seg = relabel(seg)
        self.iou_matrix = iou_matrix(gt, seg)
